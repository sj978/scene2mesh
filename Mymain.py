...
vgg16 = VGG16(requires_grad=False).to(device)
...
encoded_image = vgg16(img.unsqueeze(0))
displ_encoded = encoded_image
print("shape is ", encoded_image.shape)
print("hey target image's clip encode shape is", encoded_image.shape)
